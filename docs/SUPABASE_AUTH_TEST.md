...
| 13 | Signup (confirmation ON) → exact “Account created. Please verify your email before signing in.”; request contained **only** `full_name`/`company_name`/`phone`, **no role** | ✅ |
