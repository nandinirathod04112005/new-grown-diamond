...
| 13 | Signup (confirmation ON) → exact “Account created. Please check your email to verify your account.”; request contained **only** `full_name`/`company_name`/`phone`, **no role** | ✅ |
