            ...
            <figure className={styles.visual}>
              <div className={styles.aperture}>
                ...
                */}
                ...
                {/*
                  THE BLADES.
                  The reference's object is a comb of thin lit plates receding
                  into the dark, with the light living along their edges rather
                  than on their faces. Here that comb is cut to the outline of
                  a brilliant: same effect, made of diamond.

                  Three layers, because one cannot do it. `.blades` is the comb
