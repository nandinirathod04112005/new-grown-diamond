...
export default function Footer(){return <footer className={styles.root}>
  ...
  <div className={styles.grid}>
    ...
    <address><p>Diamond desk</p><a href="tel:+919913999794">+91 99139 99794</a><a href="mailto:newgrowndiamonds@gmail.com">newgrowndiamonds@gmail.com</a><span>Surat · Mumbai · New York · Hong Kong</span></address>
  </div>
