...
(function () {
  ...
  var CHAPTERS = [
    ...
    { sel: '#diamond-shapes', id: 'shapes', p: {
      top: [14, 18, 31], bot: [7, 10, 18],
      glowA: { x: 0.5, y: 0.3, r: 0.6, rgb: [130, 160, 230], a: 0.09 },
      glowB: { x: 0.85, y: 0.8, r: 0.4, rgb: [217, 192, 138], a: 0.08 },
      fog: 0.28, dust: 0.35, warm: 0.5, streak: 0.1, laser: 0, caustic: 0.5,
      bright: 0.9,
