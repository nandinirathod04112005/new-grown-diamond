...
(function () {
  ...
  window.NGD_CONTENT_SECTIONS = [
    ...
    { key: 'about_intro', label: 'About · Hero', page: 'about.html',
      fields: ['subheading', 'body', 'image_url'],
      hint: 'Know About Us hero eyebrow, lead and optional hero image.' },
    { key: 'about_company', label: 'About · Introduction', page: 'about.html',
      fields: ['subheading', 'body', 'image_url'],
      hint: 'Company introduction copy and optional image.' },
    { key: 'about_legacy', label: 'About · Legacy', page: 'about.html',
      fields: ['subheading', 'body', 'image_url'],
      hint: 'Four Decades in Diamonds copy and optional image.' },
    { key: 'about_surat', label: 'About · Surat Manufacturing', page: 'about.html',
      fields: ['subheading', 'body', 'image_url'],
      hint: 'Built in Surat copy and optional facility image.' },
    { key: 'about_mission', label: 'About · Mission', page: 'about.html',
      fields: ['subheading', 'body', 'image_url'],
      hint: 'Our Mission copy and optional image.' },
